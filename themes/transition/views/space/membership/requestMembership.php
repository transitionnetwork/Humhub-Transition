...
/**
 * Messages for the request membership question, per space
 * @var array $messages
 * 'space-url' => 'Text message',
 */
$messages = [
    'test-space-for-marc' => 'Test message',
];
?>
...
<div class="modal-dialog animated fadeIn">
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <?= $messages[$space->url] ?? Yii::t('SpaceModule.base', 'Access to this Space is restricted. Please introduce yourself to become a member.') ?>
